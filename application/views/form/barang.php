              ...
              <div class="col-xs-6">
                <form class="form-horizontal" method="post" action="<?php echo base_url().'barang/submit/'.$data['id'];?>">
                  <div class="form-group">
                    <label for="barang" class="col-xs-2 control-label">Produk</label>
                    <div class="col-xs-10">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-xs-10"><input class="form-control" value="<?php echo $data['type']; ?>" id="type" name="type" placeholder="type barang" type="text"></div>
                  </div>
                  <div class="form-group">
                    <label for="merk" class="col-xs-2 control-label">Merk</label>
                    <div class="col-xs-10"><input class="form-control" value="<?php echo $data['merk']; ?>" id="merk" name="merk" placeholder="merk barang" type="text"></div>
                  </div>
                  <div class="form-group">
                    <label for="spesifikasi" class="col-xs-2 control-label">Spesifikasi</label>
                    <div class="col-xs-10"><textarea id="spesifikasi" name="spesifikasi" placeholder="spesifikasi" style="width: 100%; height: 80px; font-size: 13px; line-height: 15px; border: 0.1px solid #dddddd; padding: 10px;"><?php echo $data['spesifikasi']; ?></textarea></div>
                  </div>
                  ...
                  <table class="list1 table table-hover table-striped">
                    <thead>
                      <tr>
                        ...
                        <th width="50%" class="text-center">Spesifikasi</th>
                        <th width="10%" class="text-center"></th>
                      </tr>
                    </thead>
                    <tbody>
