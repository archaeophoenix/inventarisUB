      ...
      <div class="col-xs-12">
        ...
        <div class="box-footer">
          ...
          <?php } else { ?>
            ...
            <?php if($level > 0){ ?>
            <button type="button" class="btn btn-primary btn-circle" title="Report Permintaan" onclick="window.location='<?php echo base_url().'report/permintaan/'.$id ?>'"><i class="fa fa-angle-right"></i></button>
          <?php }
          } ?>
          </div>
        </div>
