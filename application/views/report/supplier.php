        ...
        <div class="box">
          ...
          <!-- /.box-body -->
            <div class="box-footer text-right">
              ...
              <button type="button" onclick="window.location='<?php echo url.'/../../../list/'.$param['tahun'].'/'.$param['bulan']; ?>'" class="btn btn-danger btn-circle batal" title="Batal"><i class="fa fa-close"></i></button>
            <?php } else { ?>
              <button type="button" onclick="window.location='<?php echo url.'/../../../edit/'.$param['tahun'].'/'.$param['bulan']; ?>'" class="btn btn-info btn-circle" title="Edit"><i class="fa fa-pencil-square-o"></i></button>
